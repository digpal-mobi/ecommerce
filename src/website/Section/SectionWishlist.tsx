  ...
  const handleRemove = (id: number, title: string) => {
    ...
    dispatch(
      showToast({
        ...
        message: `Removed "${title}" from your wishlist`,
        type: "success",
      }),
    );
  };
  ...
  const handleAddAllToCart = () => {
    ...
    dispatch(
      showToast({
        ...
        message: `Added all ${items.length} wishlist items to your cart`,
        type: "success",
      }),
    );
  };
      ...
      <div className="pb-[80px]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-[24px] border-b border-[#000000]/10">
          <div>
            ...
            <Paragraph variant="normalPara" className="mt-1 text-[#000000]/60">
